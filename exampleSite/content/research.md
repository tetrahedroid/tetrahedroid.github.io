...
- 氷の新しい結晶構造をさがせ
- ドライアイスはどう凍る?
- ほんのわずかにメタンハイドレートに加えるだけで結晶構造を変える物質SCAをさがせ
- 正四面体型分子(メタン、CF4、etc.)はどんな結晶構造になるか
- 非分極分子の水和結晶がなぜ分極するのか
- 正五角形の雪は作れるか
- 誘電体氷はどうやって凍るのか: 氷が付着しない表面を設計できるか
- 水素結合をどう定義すれば良いか; 機械学習で自動判別器を作れるか
- 水の液液相分離の機構: 疎水•親水性溶質の影響
- せまい隙間に入った水はどんな氷になるのか?
- 水はなぜ4℃以下で膨張するのか? 水分子の形を変えてみる
- 氷表面への分子吸着機構
- 食塩の溶解度を予測できるか
- 飽和塩水(NaCl, CsCl)から塩が析出する機構の解明
- 氷の融点を上げる物質をさがす (凝固点上昇?)
- 不純物は氷の中をどうやって移動するか.
- 氷よりもさらに密度の低い氷は作れるか.
- 3Dプリンタによる、新しい分子模型の設計
